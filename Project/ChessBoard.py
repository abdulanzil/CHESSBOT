...
class ChessBoard:
    ...
    def checkKingGuard(self,fromPos,moves,specialMoves={}):
        ...
        for m in moves:
            ...
            if specialMoves.__contains__(m) and specialMoves[m] == self.EP_CAPTURE_MOVE:
    ...
    def movePawn(self,fromPos,toPos):
        ...
        if specialMoves.__contains__(toPos):
    ...
    def _parseTextMove(self,txt):
        ...
        # Get the destination
        if not files.__contains__(t[-2]) or not ranks.__contains__(t[-1]):
            return None
    ...
    def printBoard(self,image):
        ...
        for l in self._board:
            ...
            img15=self.guiupdate(img15,l,art)
            rank-=1
            art=art+1
        print ("  +-----------------+")
    ...
    def returnBoard(self):
        return self._board
    def guiupdate(self,image,l,art):
        img14=image
        for i in range(0,8):
            piece=l[i]
            if piece!='.':
                img13=self.chesspieces(piece)
                img14[(art*100):((art+1)*100),(i*100):((i+1)*100)]=img13
        return img14

    def chesspieces(self,piece):
        img12=cv2.imread(piece+'.png')
        img12=cv2.resize(img12,(100,100))
        return img12
